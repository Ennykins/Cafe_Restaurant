...
public class CustomerDashViewBookingsController extends Page{
    ...
    @FXML
    private TableColumn<Booking, Booking> approved;
...
class MyStringTableCell2 extends TableCell<Booking, String> {
...
class MyEventHandler2 implements EventHandler<MouseEvent> {
