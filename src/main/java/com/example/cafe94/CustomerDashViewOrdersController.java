...
public class CustomerDashViewOrdersController extends Page{
    ...
    public void initialize() {
        ...
        action.setCellValueFactory((TableColumn.CellDataFeatures<Order,String> x) -> {
            ...
            ObservableValue<String> f =  new SimpleStringProperty("remove") ;
            return f;
        });
...
class MyStringTableCell extends TableCell<Order, String> {
